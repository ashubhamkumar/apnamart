...
export const getProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await apnaMart.get(url);
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.get(`/api/v1/product/${id}`);
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.put("/api/v1/review", reviewData, config);
...
export const getSliderProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.get("/app/products");
    dispatch({
      type: SLIDER_PRODUCTS_SUCCESS,
      payload: data.products.rows,
    });
  } catch (error) {
    dispatch({
...
export const getAdminProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.get("/api/v1/admin/products");
...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.delete(`/api/v1/admin/product/${id}`);
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await apnaMart.get(`/api/v1/admin/reviews?id=${id}`);
