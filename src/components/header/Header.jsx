          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="flex  grow justify-center mx-5 px-4 items-center bg-white rounded-md shadow-md lg:min-w-xl lg:max-w-2xl">
                  <input
                    type="text"
                    placeholder="Search for puroducts, brands and more"
                    className="w-full border-transparent border-white "
                  />
