        ...
        <div className="mx-auto  py-2 px-2 sm:px-4">
          <div className="flex flex-wrap items-center justify-between">
            ...
            <div className="order-3 mt-2 w-full flex-shrink-0 sm:order-2 sm:mt-0 sm:w-auto">
              <a
                href="https://youtu.be/KTmhVbybIcs"
                target={"_blank"}
                rel="noopener noreferrer"
                className="flex items-center justify-center rounded-md border whitespace-nowrap border-transparent bg-white px-4 py-2 text-sm font-medium text-indigo-600 shadow-sm hover:bg-indigo-50"
              >
                View Demo
              </a>
            </div>
